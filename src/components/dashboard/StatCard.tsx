...
export const StatCard: React.FC<StatCardProps> = ({
  ...
  return (
    <div 
      onClick={onClick}
      className={`bg-white rounded-2xl p-3.5 border border-gray-100 shadow-[0_4px_20px_rgba(0,0,0,0.03)] flex flex-col justify-between min-h-[96px] h-auto ${onClick ? 'cursor-pointer hover:border-emerald-200 transition relative' : ''} ${className}`}
    >
